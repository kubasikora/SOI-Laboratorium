...
struct proc {
  ...
  unsigned char pri_group;	/* custom priority group */\
  unsigned char cycles;         /* how many cycles */
...
/* Custom priority groups */
#define PRI_GROUP_A     0       /* Pid divisable by 2 */
#define PRI_GROUP_B     1       /* Pid not divisable by 2 */
