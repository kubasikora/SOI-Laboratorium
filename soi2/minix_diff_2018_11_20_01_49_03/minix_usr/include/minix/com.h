...
#	define SYS_FINDPROC  21	/* fcn code for sys_findproc(name, &task_nr,
				   flags) */
#	define SYS_GETPRIGROUP 22 /*fcn code for sys_getprigroup */
#	define SYS_CHANGEPRIGROUP 23 /*fcn code for sys_changeprigroup */
#  	define SYS_SETSCHEDULER 24 
#	define SYS_GETUSAGETIME 25
